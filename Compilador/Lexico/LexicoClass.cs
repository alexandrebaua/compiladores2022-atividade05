...
namespace Compilador.Lexico
{
    ...
    public class LexicoClass
    {
        ...
        public LexicoClass(string entrada, bool ignorarEspacos = true)
        {
            ...
            this.ListaTokens = LexicoClass.ProcessaEntrada(entradaLinhas, ignorarEspacos);
        }
        ...
        private static TokenClass[] ProcessaEntrada(string[] entrada, bool ignorarEspacos)
        {
            int estado = 0;
